...
def fill_in_the_blanks(noun, verb, adjective):
    ...
    # The \ lets the string continue on the next line
...
def create_story():
    """Creates a story by capturing the input and displaying a finished sto."""
    noun = get_word('noun')
    verb = get_word('verb')
...
#
# Fontes:
# Curso Python for Beginners: Learn Python Programming Udemy Aula 38 a 42
