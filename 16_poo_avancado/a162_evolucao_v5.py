...
'''
Classes Abstradas, no python por padrao esse conceito nao esta nativamente
disponível no pytho, mas existe algumas formas diferentes de implementar esse
recurso
...
# Fontes:
# Curso Python 3 - Curso Completo do Básico ao Avançado Udemy Aula 162
