...
'''
Criado execao especifica par ao projeto
Exception é a super classe das excoes em python
esta usadno o pass para ter um execao personalizar e utilizar
os atributos passados pelo Exception

except IndexError as e:
Referenciando o index error como "e"
Lançando o erro de tarefa nao encontrada linha 54
'''


class TarefaNaoEncontrada(Exception):
    pass  # Excessao personalizada
...
if __name__ == '__main__':
    main()
# Fontes:
# Curso Python 3 - Curso Completo do Básico ao Avançado Udemy Aula 154
