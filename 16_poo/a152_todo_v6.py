...
'''
Métodos privados
Convensão python, métodos que não devem ser chamados fora da classe
começam com _ sao os metodos privados, ex
def _add_tarefa(self, tarefa, **kwargs):

Aula demostraram a simulacao de um overload da funcao
...
# Fontes:
# Curso Python 3 - Curso Completo do Básico ao Avançado Udemy Aula 152
