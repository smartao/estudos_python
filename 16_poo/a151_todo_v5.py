...
Criando a classe filho TarefaRecorrente, dentreo de () é referenciado
a classe pai (super). Dessa forma atributos e comportamentos serao importados
para a classe filho.
super().__init__(descricao, vencimento)
referenciando o construtor da classe pai
...
class TarefaRecorrente(Tarefa):
    def __init__(self, descricao, vencimento, dias=7):
        super().__init__(descricao, vencimento)
        self.dias = dias  # Carregando parametro extra
...
# Fontes:
# Curso Python 3 - Curso Completo do Básico ao Avançado Udemy Aula 151
