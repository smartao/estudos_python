...
'''
Aula explicadno sobrecarga de operadores

def __iadd__(self, tarefa):
Funcao que server para fazer a sobrecarga do operadora +=
Fontes https://is.gd/enF14R What exactly does += do in python?
...
# Fontes:
# Curso Python 3 - Curso Completo do Básico ao Avançado Udemy Aula 153
